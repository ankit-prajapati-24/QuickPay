...
const VerifyOtp = () => {
  ...
  const handleVerifyAndSignup = async (event) => {
    ...
    try {
      ...
      const res = await apiConnecter("POST", process.env.REACT_APP_EVENT_OTP_VERIFY,"","",{otp:otp,gmail:email});
      if (ref.current) {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center bg-gradient-to-br from-purple-200 to-white">
