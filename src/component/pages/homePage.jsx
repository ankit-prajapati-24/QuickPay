...
import whyusmodel from '../auth/assets/thinking-girl-2-removebg-preview.png'
const HomePage = () => {
  ...
  return (
    <div className="min-w-full bg-gradient-to-r from-purple-50 to-blue-50 mx-auto overflow-hidden">
      {/* Navbar */}
      {/* <Navbar /> */}
      ...
      {/* Hero Section */}
     {
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:w-1/2 pr-8 mb-8 md:mb-0" data-aos="fade-right">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#6c5ce7] mb-6">
            Revolutionize Transactions in Your Environment
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8">
            A decentralized digital token system for colleges, offices, events, and more. Manage transactions seamlessly without relying on traditional banking systems.
          </p>
          <div className="space-x-4 space-y-2">
            <button className="bg-[#6c5ce7] text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg hover:bg-purple-800 transition duration-300">
              Get Started
            </button>
            <button className="bg-white text-[#6c5ce7] px-4 py-2 sm:px-6 sm:py-3 rounded-lg border border-[#6c5ce7] hover:bg-purple-50 transition duration-300">
              Learn More
            </button>
          </div>
        </div>
      ...
      <div id="how-it-works" className="bg-gradient-to-r from-purple-50 to-blue-50 py-12">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-[#6c5ce7] text-center mb-8 md:mb-16" data-aos="fade-up">
            How It Works
          </h2>
          <div className="relative">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-8 md:mb-16" data-aos="fade-right">
              <div className="w-full md:w-1/2 md:pr-8 text-center md:text-left">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-[#6c5ce7] rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-white text-lg md:text-2xl font-bold">1</span>
                </div>
                <h3 className="text-lg md:text-xl font-bold text-[#6c5ce7] mb-2">Admin Registers Entity</h3>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center justify-between mb-8 md:mb-16" data-aos="fade-left">
              <div className="w-full md:w-1/2 md:pl-8 text-center md:text-right">
                ...
                <h3 className="text-lg md:text-xl font-bold text-[#6c5ce7] mb-2">Admin Manages Users and Merchants</h3>
                <p className="text-sm md:text-base text-gray-600">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between mb-8 md:mb-16" data-aos="fade-right">
              <div className="w-full md:w-1/2 md:pr-8 text-center md:text-left">
                ...
                <h3 className="text-lg md:text-xl font-bold text-[#6c5ce7] mb-2">Users and Merchants Transact</h3>
                <p className="text-sm md:text-base text-gray-600">
      ...
      <div className="bg-[#6c5ce7] py-16">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-purple-100 mb-8" data-aos="fade-up" data-aos-delay="200">
            Join the Digital Token System today and experience seamless, independent transactions.
          </p>
          <button
            className="bg-white text-[#6c5ce7] px-8 py-3 rounded-lg hover:bg-purple-50 transition duration-300"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            Get Started Now
  ...
  <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center">
    ...
    <div className="w-full md:w-1/2 md:pl-8" data-aos="fade-left">
      <h2 className="text-3xl font-bold text-[#6c5ce7] mb-8">
        Why Choose Us?
      </h2>
      <ul className="space-y-6">
        ...
        <li className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-xl font-bold text-[#6c5ce7] mb-2">Independent Transaction Environment</h3>
        ...
        <li className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-xl font-bold text-[#6c5ce7] mb-2">Seamless User Experience</h3>
            <p className="text-gray-600">
        ...
        <li className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-xl font-bold text-[#6c5ce7] mb-2">Secure and Reliable</h3>
            <p className="text-gray-600">
        ...
        <li className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-xl font-bold text-[#6c5ce7] mb-2">Admin Control</h3>
            <p className="text-gray-600">
